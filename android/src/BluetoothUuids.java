...
public interface BluetoothUuids {
  ...
  UUID XCBK_AVIATION_SERVICE=UUID.fromString("00000000-cc7a-482a-984a-7f2ed5b3e58f");
  UUID XCBK_AVIATION_ATTITUDE_CHARACTERISTIC=UUID.fromString("00000000-8e22-4541-9d4c-21edae82ed19");
  UUID XCBK_AVIATION_PRESSURE_CHARACTERISTIC=UUID.fromString("00000001-8e22-4541-9d4c-21edae82ed19");
  UUID XCBK_AVIATION_ENVSENSORS_CHARACTERISTIC=UUID.fromString("00000002-8e22-4541-9d4c-21edae82ed19");
  UUID XCBK_AVIATION_FLARM_CHARACTERISTIC=UUID.fromString("00000003-8e22-4541-9d4c-21edae82ed19");
  UUID XCBK_AVIATION_LOCATION_CHARACTERISTIC=UUID.fromString("00000004-8e22-4541-9d4c-21edae82ed19");
